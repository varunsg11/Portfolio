...
export const skills: Skill[] = [
  { name: "Python", icon: "fab fa-python", percent: 90, blurb: "Scripting, automation, ML pipelines" },
  { name: "ABAP", icon: "fas fa-database", percent: 90, blurb: "SAP development & integrations" },
  { name: "Java", icon: "fab fa-java", percent: 80, blurb: "OOP & backend development" },
...
export const techPills = {
  alsoWorkWith: [
    "Kotlin", "Go", "YAML", "Docker", "Kubernetes", "GitHub Actions",
    "Databricks", "SAP HANA DB", "AI Core", "BTP", "ServiceNow", "JFrog",
  ],
  aiml: [
    "Multi-Agent Orchestration", "LLM Integration & Tooling", "Prompt Engineering",
    "RAG Pipelines", "Vector Databases", "NLP", "CrewAI & LangGraph", "MCP Server",
  ],
} as const;
